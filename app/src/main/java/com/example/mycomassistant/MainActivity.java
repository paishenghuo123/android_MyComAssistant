package com.example.mycomassistant;
...
import com.example.mycomassistant.bean.AssistBean;
import com.example.mycomassistant.bean.ComBean;
...
//        try {
        ...
        try {
            pinfo = getPackageManager().getPackageInfo("com.example.mycomassistant", PackageManager.GET_CONFIGURATIONS);
...
//						ComA=new SerialControl("/dev/s3c2410_serial0", "9600");
                        Log.d("ssss", SpinnerCOMA.getSelectedItem().toString());
                        ComA.setPort(SpinnerCOMA.getSelectedItem().toString());
                        Log.d("aaaa", SpinnerBaudRateCOMA.getSelectedItem().toString());
